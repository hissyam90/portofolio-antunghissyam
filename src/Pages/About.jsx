...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    <div className="inline-block relative group">
      <h2 
        className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#06b6d4] to-[#3b82f6]" 
        data-aos="zoom-in-up"
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
             Mahasiswa Informatika Universitas Mulawarman yang sedang mengembangkan passion di dunia programming dan teknologi. Saat ini aktif mempelajari fondasi ilmu komputer melalui pengalaman akademis dan praktikum hands-on.
               ...
               {/* Quote Section */}
      <div 
        className="relative bg-gradient-to-br from-[#06b6d4]/5 via-transparent to-[#3b82f6]/5 border border-gradient-to-r border-[#06b6d4]/30 rounded-2xl p-4 my-6 backdrop-blur-md shadow-2xl overflow-hidden"
        data-aos="fade-up"
        data-aos-duration="1700"
      >
        {/* Floating orbs background */}
        <div className="absolute top-2 right-4 w-16 h-16 bg-gradient-to-r from-[#06b6d4]/20 to-[#3b82f6]/20 rounded-full blur-xl"></div>
        <div className="absolute -bottom-4 -left-2 w-12 h-12 bg-gradient-to-r from-[#3b82f6]/20 to-[#06b6d4]/20 rounded-full blur-lg"></div>
          ...
          "A strong foundation in the first semester will form a solid career in technology."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
                className="w-full lg:w-auto sm:px-6 py-2 sm:py-3 rounded-lg bg-gradient-to-r from-[#06b6d4] to-[#3b82f6] text-white font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center lg:justify-start gap-2 shadow-lg hover:shadow-xl "
              >
              ...
              <button 
                data-aos="fade-up"
                data-aos-duration="1000"
                className="w-full lg:w-auto sm:px-6 py-2 sm:py-3 rounded-lg border border-[#3b82f6]/50 text-[#3b82f6] font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center lg:justify-start gap-2 hover:bg-[#3b82f6]/10 "
              >
